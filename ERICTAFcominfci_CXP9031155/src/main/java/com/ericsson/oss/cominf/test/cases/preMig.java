...
public class preMig extends TorTestCaseHelper implements TestCase {
     ...
     @TestId(id = "OSS_151539_Func01", title = "Create_AIF_Users")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS151539Func01")

     public void OSS151539Func01(
     ...
     @TestId(id = "OSS_151539_Func02", title = "Bulk_User_Addition_in_SUNDS")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS151539Func02")

     public void OSS151539Func02(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
     ...
     @TestId(id = "OSS_151539_Func03", title = "COMINF_PREMIG_BACKUP")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS151539Func03")

     public void OSS151539Func03(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
...
//nedss
     ...
     @TestId(id = "OSS_151539_Func04", title = "Cominf_pre_migration_verification_tasks")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS151539Func04")

     public void OSS151539Func04(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
