...
public class ericOCS extends TorTestCaseHelper implements TestCase {
     ...
     @TestId(id = "OSS_40739_Func01", title = "DHCP service stopping")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func01")

     public void OSS40739Func01(
     ...
     @TestId(id = "OSS_40739_Func02", title = "DHCP Serivce on om_serv slave")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func02")

     public void OSS40739Func02(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
     ...
     @TestId(id = "OSS_40739_Func03", title = "verify the addition,listing and deleting of networks,clients,lte_clients to the DHCP server is successful as root user")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func03")

     public void OSS40739Func03(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
     ...
     @TestId(id = "OSS_40739_Func04", title = "verify the addition,deletion and lsiting of networks,clients,lte_clients to the DHCP server is successful as BSIM user")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func04")

     public void OSS40739Func04(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
...
*/ // SOL11 Exclusion
     ...
     @TestId(id = "OSS_40739_Func10", title = "Verify NTPV4 service in UAS after upgrade")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func10")

     public void OSS40739Func10(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
     ...
     @TestId(id = "OSS_40739_Func15", title = "Checking of named.ca file present under /var/named/ in Infra master")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func15")

     public void OSS40739Func15(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
     ...
     @TestId(id = "OSS_40739_Func16", title = "Checking ipv6 dns files under /var/named/")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func16")

     public void OSS40739Func16(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
     ...
     @TestId(id = "OSS_40739_Func17", title = "Updation of CDP hostnames in DNS DB")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func17")

     public void OSS40739Func17(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
     ...
     @TestId(id = "OSS_40739_Func21", title = "HT84931")
     @Context(context = {Context.CLI})
     @Test(groups={ "KGB" })
     @DataDriven(name = "OSS40739Func21")

     public void OSS40739Func21(
            @Input("executeFile")String executeFileCmd,
            @Input("file")String file,
            @Input("changeDir") String changeDirCmd,
            @Input("fileLocation") String fileLocation,
